...
public class JfAsignaAsignatura extends javax.swing.JFrame {

    public JfAsignaAsignatura() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JfAsignaAsignatura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JfAsignaAsignatura().setVisible(true);
            }
        });
    }
